...
CREATE TABLE stg.[HumanResources_vEmployee] (
...
CREATE TABLE stg.[HumanResources_vEmployeeDepartment] (
...
CREATE TABLE stg.[HumanResources_vEmployeeDepartmentHistory] (
...
CREATE TABLE stg.[Sales_vIndividualCustomer] (
...
CREATE TABLE stg.[Sales_vPersonDemographics] (
...
CREATE TABLE stg.[HumanResources_vJobCandidate] (
...
CREATE TABLE stg.[HumanResources_vJobCandidateEmployment] (
...
CREATE TABLE stg.[HumanResources_vJobCandidateEducation] (
...
CREATE TABLE stg.[Production_vProductAndDescription] (
...
CREATE TABLE stg.[Production_vProductModelCatalogDescription] (
...
CREATE TABLE stg.[Production_vProductModelInstructions] (
...
CREATE TABLE stg.[Sales_vSalesPerson] (
...
CREATE TABLE stg.[Sales_vSalesPersonSalesByFiscalYears] (
...
CREATE TABLE stg.[Sales_vStoreWithDemographics] (
...
CREATE TABLE stg.[Sales_vStoreWithContacts] (
...
CREATE TABLE stg.[Sales_vStoreWithAddresses] (
...
CREATE TABLE stg.[Purchasing_vVendorWithContacts] (
[BusinessEntityID] int NOT NULL,[Name] nvarchar(50) NOT NULL,[ContactType] nvarchar(50) NOT NULL,[Title] nvarchar(8) NULL,[FirstName] nvarchar(50) NOT NULL,[MiddleName] nvarchar(50) NULL,[LastName] nvarchar(50) NOT NULL,[Suffix] nvarchar(10) NULL,[PhoneNumber] nvarchar(25) NULL,[PhoneNumberType] nvarchar(50) NULL,[EmailAddress] nvarchar(50) NULL,[EmailPromotion] int NOT NULL,
checksum binary(16), is_deleted bit, is_current bit
)
CREATE TABLE stg.[Purchasing_vVendorWithAddresses] (
[BusinessEntityID] int NOT NULL,[Name] nvarchar(50) NOT NULL,[AddressType] nvarchar(50) NOT NULL,[AddressLine1] nvarchar(60) NOT NULL,[AddressLine2] nvarchar(60) NULL,[City] nvarchar(30) NOT NULL,[StateProvinceName] nvarchar(50) NOT NULL,[PostalCode] nvarchar(15) NOT NULL,[CountryRegionName] nvarchar(50) NOT NULL,
checksum binary(16), is_deleted bit, is_current bit
)
...
CREATE TABLE stg.[dbo_DatabaseLog] (
...
CREATE TABLE stg.[dbo_AWBuildVersion] (
...
CREATE TABLE stg.[dbo_sysdiagrams] (
...
CREATE TABLE stg.[dbo_Sales_CreditCard] (
...
CREATE TABLE stg.[dbo_Production_Location] (
...
--	print CONCAT('CREATE TABLE stg.[', @table_schema, '_', @table_name,'] (')
--	print @sql
...
CREATE TABLE stg.[Person-GeneralContact]
(
...
CREATE TABLE stg.[Person-IndividualCustomer]
(
  BusinessEntityID INT ,
  PersonType VARCHAR(5) ,
  ModifiedDate DATETIME,
...
CREATE TABLE stg.[Person-Non-salesEmployee]
(
  BusinessEntityID INT ,
  PersonType VARCHAR(5) ,
  ModifiedDate DATETIME,
...
CREATE TABLE stg.[Person-SalesPerson] (
    BusinessEntityID INT,
    PersonType VARCHAR(5),
    ModifiedDate DATETIME,
    FirstName VARCHAR(50),
...
CREATE TABLE stg.[Person-StoreContact]
(
  BusinessEntityID INT,
  PersonType VARCHAR(5) ,
  ModifiedDate DATETIME ,
...
CREATE TABLE stg.[Person-VendorContact]
(
	  BusinessEntityID INT,
	  PersonType VARCHAR(5) ,
	  ModifiedDate DATETIME ,
...
CREATE TABLE stg.TransactionHistory (
...
CREATE TABLE stg.CountryOfBusinessEntity (
    BusinessEntityID INT,
